...
// </editor-fold>
    ...
    @PUT
    public Response update(@RequestBody(description = "Crea un nuevo building.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Building.class))) Building building) ;
// </editor-fold>
    ...
    public Response delete( @Parameter(description = "El elemento idbuilding", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("idbuilding") Long idbuilding);
    // </editor-fold>
    ...
    // </editor-fold>
       ...
       // <editor-fold defaultstate="collapsed" desc="Long countLikeByBuilding(@QueryParam("building") String building)">
    @GET
    @Path("countlikebybuilding")
    public Long countLikeByBuilding(@QueryParam("building") String building);
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="List<Building> likeByBuilding(@QueryParam("building") String building)">

    @GET
    @Path("likebybuilding")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Building> likeByBuilding(@QueryParam("building") String building);
    // </editor-fold>
}
