...
//@ApplicationScoped
public interface OtpRestClient {
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Otp findByIdotp(@PathParam("idotp") Long idotp)">
    @GET
    @Path("{idotp}")
    public Otp findByIdotp(@Parameter(description = "El idotp", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("idotp") Long idotp);
// </editor-fold>

//    // <editor-fold defaultstate="collapsed" desc="Otp findByOtp(final String otp)">
    @GET
    @Path("otp")
    public List<Otp> findByOtp(@Parameter(description = "El otp", required = true, example = "1", schema = @Schema(type = SchemaType.STRING)) @QueryParam("otp") final String otp);
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="List<Otp> findByIduser(@QueryParam("iduser") final Long iduser)">
    @GET
    @Path("iduser")
    public List<Otp> findByIduser(@QueryParam("iduser") final Long iduser);
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="List<Otp> findByIduser(@QueryParam("iduser") final Long iduser)">
    @GET
    @Path("email")
    public List<Otp> findByEmail(@QueryParam("email") final String email);
// </editor-fold>
    ...
    public Response save(@RequestBody(description = "Crea un nuevo otp.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Otp.class))) Otp otp);
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Response update">

    @PUT

    public Response update(@RequestBody(description = "Crea un nuevo otp.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Otp.class))) Otp otp);
...
// </editor-fold>
    ...
    public Response delete(@Parameter(description = "El elemento idotp", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("idotp") Long idotp);
