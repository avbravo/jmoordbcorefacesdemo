...
// </editor-fold>
    ...
    @PUT
    public Response update(@RequestBody(description = "Crea un nuevo country.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Country.class))) Country country) ;
// </editor-fold>
    ...
    public Response delete( @Parameter(description = "El elemento idcountry", required = true, example = "1", schema = @Schema(type = SchemaType.STRING)) @PathParam("idcountry") String idcountry);
    // </editor-fold>
    ...
    // </editor-fold>
       ...
       // <editor-fold defaultstate="collapsed" desc="Long countLikeByCountry(@QueryParam("country") String country)">
    @GET
    @Path("countlikebycountry")
    public Long countLikeByCountry(@QueryParam("country") String country);
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="List<Country> likeByCountry(@QueryParam("country") String country)">

    @GET
    @Path("likebycountry")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Country> likeByCountry(@QueryParam("country") String country);
    // </editor-fold>
}
