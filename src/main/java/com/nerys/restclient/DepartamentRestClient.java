...
public interface  DepartamentRestClient {
...
// </editor-fold>
    ...
    @GET
    @Path("{iddepartament}")
    public Departament findByIddepartament(@Parameter(description = "El iddepartament", required = true, example = "1", schema = @Schema(type = SchemaType.NUMBER)) @PathParam("iddepartament") Long iddepartament) ;
// </editor-fold>
...
// </editor-fold>
    ...
    @PUT
     public Response update(@RequestBody(description = "Crea un nuevo departament.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Departament.class))) Departament departament) ;
// </editor-fold>
