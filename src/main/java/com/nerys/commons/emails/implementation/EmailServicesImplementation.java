 ...
 */
package com.nerys.commons.emails.implementation;
...
// </editor-fold>
    ...
    public Boolean sendEmail(String emailDestinatario, String titulo, String mensaje) {
        ...
        try {
            ...
            if (emailconfigurationList == null || emailconfigurationList.isEmpty()) {
                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.nohayregistrosemailconfiguration"));
                return false;
            }
            ...
            if (!emailconfigurationOptional.isPresent()) {
                FacesUtil.warningDialog(rf.fromCore("warning.warning"), rf.fromMessage("warning.nohayregistrosemailconfigurationactivos"));
                return false;
            }
            ...
            final String password = Encryptor.decrypt(emailconfigurationOptional.get().getPassword(), secretKey,FacesUtil.nameOfClassAndMethod() );
    ...
    public Boolean sendEmail(String titulo, String mensaje, List<String> emailList) {
        ...
        try {
            ...
            EmailRecipients emailRecipients = FacesUtil.divideDestinatary(emailList);
